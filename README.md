...
[![CI/CD Pipeline](https://github.com/obintui10/flask-webapp-demo/actions/workflows/ci-cd.yml/badge.svg)](https://github.com/obintui10/flask-webapp-demo/actions/workflows/ci-cd.yml)
[![Docker Image](https://img.shields.io/docker/pulls/obintui10/flask-webapp-demo)](https://hub.docker.com/r/obintui10/flask-webapp-demo)
[![License](https://img.shields.io/github/license/obintui10/flask-webapp-demo)](LICENSE)
...
```mermaid
flowchart TD
    A[Browser] --> B[Flask App<br>(app.py routes: /, /about)]
    B --> C[Templates<br>(index.html, about.html)]
    B --> D[Static Assets<br>(style.css, app.js, logo.png)]
